...
public class BuglyUtil {
    ...
    public static void iniBugly(Context context){
        /**** Beta高级设置*****/
        /**
...
//        Beta.tipsDialogLayoutId = R.layout.tips_dialog;
     ...
     /*  Beta.upgradeDialogLifecycleListener = new UILifecycleListener<UpgradeInfo>() {
       ...
       /* Beta.upgradeListener = new UpgradeListener() {
         ...
         * 参数3：是否开启debug
         */
        Bugly.init(context, "0f56d32096", true);
    ...
    public static void checkUpgradeTest(){
        Beta.checkUpgrade();
    }
    ...
    public static boolean checkUpgrade(){
        ...
        if (upgradeInfo == null) {
            Log.i(TAG, "checkUpgrade: upgradeInfo == null");
            return false;
        }
        Log.i(TAG, "checkUpgrade: upgradeInfo != null" +(upgradeInfo != null));
        return true;
    }
