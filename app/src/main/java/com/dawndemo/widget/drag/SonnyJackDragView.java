package com.dawndemo.widget.drag;
...
public class SonnyJackDragView implements View.OnTouchListener {
    ...
    private void initDragView() {
        ...
        Log.i(TAG, "initDragView: top mStatusBarHeight = " + mStatusBarHeight + ", mBuilder.defaultTop = " + mBuilder.defaultTop);
        Log.i(TAG, "initDragView: 初始化的位置 ：left = " + left + ",top = " + (mStatusBarHeight + mBuilder.defaultTop));
    ...
    public boolean onTouch(View v, MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                //getRawX 是以屏幕左上角为左脚做预案，获取X坐标轴上的值
                Log.i(TAG, "onTouch: ACTION_DOWN x = "+event.getRawX() +",y = "+ event.getRawY());
                Log.i(TAG, "onTouch: ACTION_DOWN mLastX = "+mLastX +",mLastY = "+ mLastY);
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                Log.i(TAG, "onTouch: ACTION_MOVE mLastX = "+mLastX +",mLastY = "+ mLastY);
                break;
