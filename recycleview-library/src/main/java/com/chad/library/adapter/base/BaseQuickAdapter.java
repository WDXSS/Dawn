...
import com.chad.library.adapter.base.animation.Animations;
...
//    private BaseAnimation mSelectAnimation = new AlphaInAnimation();
    ...
    public BaseQuickAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
        ...
        mSelectAnimation=new Animations(BaseAnimation.ANIMATION_ALPHA);
        if (layoutResId != 0) {
    ...
    public void openLoadAnimation(@AnimationType int animationType) {
        ...
        mSelectAnimation= new Animations(animationType);
